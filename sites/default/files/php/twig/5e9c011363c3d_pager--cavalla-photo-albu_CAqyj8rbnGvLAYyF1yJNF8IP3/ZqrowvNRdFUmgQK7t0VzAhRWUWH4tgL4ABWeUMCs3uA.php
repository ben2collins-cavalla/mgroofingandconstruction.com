...
/* modules/contrib/cavalla/modules/cavalla_widgets/modules/cavalla_photo_album_feed/templates/pager--cavalla-photo-album-feed.html.twig */
class __TwigTemplate_4e31902574acc7f11f57557d3087f003764dbb29726137686bbcef8ebfec900a extends \Twig\Template
{
    ...
    <ul class=\"pager__items js-pager__items pagination\">
      ";
            ...
            if ($this->getAttribute(($context["items"] ?? null), "first", [])) {
                // line 39
                echo "        <li class=\"pager__item pager__item--first page-item\">
          <a href=\"";
                // line 40
                echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["currentPath"] ?? null)), "html", null, true);
                echo "gallery/";
      ...
      ";
            ...
            if ($this->getAttribute(($context["items"] ?? null), "previous", [])) {
                // line 48
                echo "        <li class=\"pager__item pager__item--previous page-item\">
          <a href=\"";
                // line 49
                echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["currentPath"] ?? null)), "html", null, true);
                echo "gallery/";
      ...
      ";
            ...
            if ($this->getAttribute(($context["ellipses"] ?? null), "previous", [])) {
                // line 57
                echo "        <li class=\"pager__item pager__item--ellipsis page-item\" role=\"presentation\">&hellip;</li>
      ";
            }
            // line 59
            echo "      ";
      ...
      ";
            ...
            if ($this->getAttribute(($context["items"] ?? null), "next", [])) {
                // line 81
                echo "        <li class=\"pager__item pager__item--next page-item\">
          <a href=\"";
                // line 82
                echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["currentPath"] ?? null)), "html", null, true);
                echo "gallery/";
      ...
      ";
            ...
            if ($this->getAttribute(($context["items"] ?? null), "last", [])) {
                // line 90
                echo "        <li class=\"pager__item pager__item--last page-item\">
          <a href=\"";
                // line 91
                echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["currentPath"] ?? null)), "html", null, true);
                echo "gallery/";
...
";
    ...
    {
        return "modules/contrib/cavalla/modules/cavalla_widgets/modules/cavalla_photo_album_feed/templates/pager--cavalla-photo-album-feed.html.twig";
    }
    ...
    {
        return array (  253 => 97,  246 => 93,  242 => 92,  232 => 91,  229 => 90,  226 => 89,  224 => 88,  217 => 84,  213 => 83,  203 => 82,  200 => 81,  197 => 80,  195 => 79,  191 => 77,  188 => 76,  186 => 75,  178 => 72,  176 => 71,  172 => 69,  160 => 67,  157 => 66,  154 => 65,  151 => 64,  148 => 63,  146 => 62,  141 => 61,  136 => 60,  134 => 59,  130 => 57,  127 => 56,  125 => 55,  118 => 51,  114 => 50,  104 => 49,  101 => 48,  98 => 47,  96 => 46,  89 => 42,  85 => 41,  75 => 40,  72 => 39,  69 => 38,  62 => 35,  57 => 34,  55 => 33,);
    }
    ...
    <ul class=\"pager__items js-pager__items pagination\">
      ...
      {% if items.first %}
        <li class=\"pager__item pager__item--first page-item\">
          <a href=\"{{ currentPath }}gallery/{{ items.first.href }}\" title=\"{{ 'Go to first page'|t }}\"{{ items.first.attributes|without('href', 'title') }} class=\"page-link\">
      ...
      {% if items.previous %}
        <li class=\"pager__item pager__item--previous page-item\">
          <a href=\"{{ currentPath }}gallery/{{ items.previous.href }}\" title=\"{{ 'Go to previous page'|t }}\" rel=\"prev\"{{ items.previous.attributes|without('href', 'title', 'rel') }} class=\"page-link\">
      ...
      {% for key, item in items.pages %}
        <li class=\"pager__item{{ current == key ? ' is-active' : '' }} page-item\">
          ...
          {% endif %}
          <a href=\"{{ currentPath }}gallery/{{ item.href }}\" title=\"{{ title }}\"{{ item.attributes|without('href', 'title') }} class=\"page-link\">
            <span class=\"visually-hidden\">
      ...
      {% if items.next %}
        <li class=\"pager__item pager__item--next page-item\">
          <a href=\"{{ currentPath }}gallery/{{ items.next.href }}\" title=\"{{ 'Go to next page'|t }}\" rel=\"next\"{{ items.next.attributes|without('href', 'title', 'rel') }} class=\"page-link\">
      ...
      {% if items.last %}
        <li class=\"pager__item pager__item--last page-item\">
          <a href=\"{{ currentPath }}gallery/{{ items.last.href }}\" title=\"{{ 'Go to last page'|t }}\"{{ items.last.attributes|without('href', 'title') }} class=\"page-link\">
...
{% endif %}
", "modules/contrib/cavalla/modules/cavalla_widgets/modules/cavalla_photo_album_feed/templates/pager--cavalla-photo-album-feed.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/mgroofingandconstruction.com/modules/contrib/cavalla/modules/cavalla_widgets/modules/cavalla_photo_album_feed/templates/pager--cavalla-photo-album-feed.html.twig");
    }
}
